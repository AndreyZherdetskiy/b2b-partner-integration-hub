...
`docker compose up -d --build`; migrate; seed; `make ci`; manual dataflow (happy outbound, 400→DLQ, HMAC 403, duplicate 200, sandbox); logs; write local gitignored architecture audit dated 2026-06-04. Do not write Stage Done.
