...
**Files:**
- Create: `app/domain/models/payload_schema.py`, `app/domain/services/schema_registry.py`, `alembic/versions/20260316_0005_payload_schemas.py`, `tests/unit/test_schema_registry.py`
...
**Files:**
- Create: `app/domain/models/replay_approval.py`, `app/domain/enums.py` (`ReplayApprovalStatus`: `pending`/`approved`/`rejected`), `app/api/v1/admin/replay_approvals.py`, `alembic/versions/20260316_0006_replay_approvals.py`, `tests/unit/test_replay_approval.py`
