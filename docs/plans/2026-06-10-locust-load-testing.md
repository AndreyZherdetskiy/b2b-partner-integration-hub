...
| `docs/plans/2026-06-10-locust-load-testing.md`, `docs/perf/locust-smoke.md`, `docs/runbooks/load-testing.md`, `docs/perf/README.md`, `AGENTS.md`, `README.md`, `CONTRIBUTING.md` | `.superpowers/` (briefs, reports, ledger) |
...
**Status:** complete — review APPROVE (2026-06-10). No commit. Minors: untested `main()`, packaging/mypy deferred.
...
**Status:** complete — review APPROVE (2026-06-10). No commit. Minors: Makefile help wording, sed parse, locust --list class-only.
...
**Status:** complete — review APPROVE (2026-06-10). No commit.
