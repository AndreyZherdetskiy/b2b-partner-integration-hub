...
These numbers are **not** spec §8.1 NFR. Persist-CTE before-picture: [`ceiling-persist-cte.md`](./ceiling-persist-cte.md). Plan: [`docs/plans/2026-06-13-kafka-lag-drain-remeasure.md`](../plans/2026-06-13-kafka-lag-drain-remeasure.md).
...
| `hub-api` image | `8563e07b6141` created `2026-06-13T20:00:30Z` |
...
Date: 2026-06-13. Fail % **0**. Persist-CTE figures from [`ceiling-persist-cte.md`](./ceiling-persist-cte.md).
