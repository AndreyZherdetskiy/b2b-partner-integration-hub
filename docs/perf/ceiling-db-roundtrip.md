...
| `hub-api` image | `5562fff622ea` created `2026-04-02T18:40:08Z` (Wave 7 remesure image was `bf53722e2b72`) |
...
CSV columns: `# reqs`, RPS, fail%, p50/p99. Date: 2026-04-02. Wave 7 figures from [`ceiling-accept-path.md`](./ceiling-accept-path.md).
...
- Plan: [`docs/plans/2026-03-27-accept-path-db-opt.md`](../plans/2026-03-27-accept-path-db-opt.md)
