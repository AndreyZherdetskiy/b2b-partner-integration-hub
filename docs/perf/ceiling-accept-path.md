...
| `hub-api` image | `bf53722e2b72` created `2026-04-02T18:05:23Z` (Wave 6 remesure image was `45112fde3feb`) |
...
CSV columns: `# reqs`, RPS, fail%, p50/p99. Date: 2026-04-02. Wave 6 figures from [`ceiling-remeasure.md`](./ceiling-remeasure.md).
...
- Plan: [`docs/plans/2026-03-27-accept-path-opt.md`](../plans/2026-03-27-accept-path-opt.md)
