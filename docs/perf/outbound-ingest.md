...
|------|-----|----------|------------------------------------------------------|-------------------|
| 2026-04-02 | 2 | 10s | 40.88 | yes (818/818 HTTP 202) |
| 2026-04-03 | 2 | 10s | 11.82 | yes (2252/2252 HTTP 202; overlay after persist CTE; k6 via stdin — WSL bind-mount of `make load-k6` failed) |
