...
| `hub-api` image | `45112fde3feb` created `2026-06-14T17:17:59Z` (pre-rebuild `14d6dda222af`) |
...
CSV columns: `# reqs`, RPS, fail%, p50/p99. Date: 2026-06-14. Wave 4 figures from [`ceiling-prodlike.md`](./ceiling-prodlike.md).
...
- Plan: [`docs/plans/2026-06-14-remeasure.md`](../plans/2026-06-14-remeasure.md)
