...
| `hub-api` image | `9baf962af590` created `2026-06-13T19:24:48Z` (Wave 8 remesure image was `5562fff622ea`) |
...
CSV columns: `# reqs`, RPS, fail%, p50/p99. Date: 2026-06-13. Wave 8 figures from [`ceiling-db-roundtrip.md`](./ceiling-db-roundtrip.md).
...
|------|-----|----------|----------|--------------------------------------------------|--------------|
| 2026-06-13 | 2 | 10s | 2252/2252 | 11.82 ms | yes |
...
- Plan: [`docs/plans/2026-06-13-persist-cte-remeasure.md`](../plans/2026-06-13-persist-cte-remeasure.md)
