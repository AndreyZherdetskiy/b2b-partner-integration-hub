...
Plan: [`docs/plans/2026-03-16-ci-pre-commit.md`](../plans/2026-03-16-ci-pre-commit.md).
...
5. Name **one** primary limiter from the observation table in [`docs/plans/2026-04-03-ceiling-hunt.md`](../plans/2026-04-03-ceiling-hunt.md). `make load-k6-grafana` is constant VUs — skip `ramping-arrival-rate` unless you add a separate script. No `--no-thresholds`.
